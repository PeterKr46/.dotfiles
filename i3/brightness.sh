...
brightness $1
# Send a notification
notify-send "Brightness" -i $backlight_icon "<tt>$(~/.config/i3/pango_bar $state $backlight_min $backlight_max )</tt>" -h string:x-canonical-private-synchronous:brightness
